...
local Icons = { Logo = "rbxassetid://132293597304547" }

local Themes = {
    ["Black Metal"] = { name="Black Metal", BG=Color3.fromRGB(0,0,0), Sidebar=Color3.fromRGB(18,18,18), Card=Color3.fromRGB(26,26,26), CardHover=Color3.fromRGB(38,38,38), Border=Color3.fromRGB(45,45,45), Text=Color3.fromRGB(230,230,230), TextMuted=Color3.fromRGB(150,150,150), Accent=Color3.fromRGB(192,192,192), AccentDark=Color3.fromRGB(150,150,150), Success=Color3.fromRGB(100,200,100), Error=Color3.fromRGB(230,80,80), Warning=Color3.fromRGB(255,200,50), Divider=Color3.fromRGB(35,35,35) },
    Amethyst = { name="Amethyst", BG=Color3.fromRGB(11,11,16), Sidebar=Color3.fromRGB(15,15,22), Card=Color3.fromRGB(20,20,30), CardHover=Color3.fromRGB(26,26,38), Border=Color3.fromRGB(30,30,44), Text=Color3.fromRGB(232,232,240), TextMuted=Color3.fromRGB(105,105,128), Accent=Color3.fromRGB(150,100,255), AccentDark=Color3.fromRGB(110,70,200), Success=Color3.fromRGB(74,222,128), Error=Color3.fromRGB(248,113,113), Warning=Color3.fromRGB(250,204,21), Divider=Color3.fromRGB(26,26,38) },
    Gold = { name="Gold", BG=Color3.fromRGB(14,12,8), Sidebar=Color3.fromRGB(20,17,11), Card=Color3.fromRGB(28,24,15), CardHover=Color3.fromRGB(38,32,20), Border=Color3.fromRGB(45,38,22), Text=Color3.fromRGB(245,240,225), TextMuted=Color3.fromRGB(140,125,90), Accent=Color3.fromRGB(255,200,60), AccentDark=Color3.fromRGB(210,160,30), Success=Color3.fromRGB(180,220,100), Error=Color3.fromRGB(240,100,90), Warning=Color3.fromRGB(255,180,50), Divider=Color3.fromRGB(35,30,18) },
    Ocean = { name="Ocean", BG=Color3.fromRGB(8,12,18), Sidebar=Color3.fromRGB(11,16,25), Card=Color3.fromRGB(15,22,34), CardHover=Color3.fromRGB(20,30,45), Border=Color3.fromRGB(24,36,55), Text=Color3.fromRGB(225,235,245), TextMuted=Color3.fromRGB(95,115,140), Accent=Color3.fromRGB(60,160,255), AccentDark=Color3.fromRGB(35,120,200), Success=Color3.fromRGB(80,220,180), Error=Color3.fromRGB(240,100,100), Warning=Color3.fromRGB(250,200,60), Divider=Color3.fromRGB(20,30,45) },
    Emerald = { name="Emerald", BG=Color3.fromRGB(8,14,11), Sidebar=Color3.fromRGB(11,20,15), Card=Color3.fromRGB(15,27,20), CardHover=Color3.fromRGB(20,36,27), Border=Color3.fromRGB(24,42,32), Text=Color3.fromRGB(225,245,232), TextMuted=Color3.fromRGB(90,130,108), Accent=Color3.fromRGB(60,220,130), AccentDark=Color3.fromRGB(30,160,90), Success=Color3.fromRGB(100,240,150), Error=Color3.fromRGB(240,100,100), Warning=Color3.fromRGB(250,210,60), Divider=Color3.fromRGB(20,34,25) },
    Crimson = { name="Crimson", BG=Color3.fromRGB(14,8,10), Sidebar=Color3.fromRGB(20,11,14), Card=Color3.fromRGB(28,15,19), CardHover=Color3.fromRGB(38,20,26), Border=Color3.fromRGB(45,24,30), Text=Color3.fromRGB(245,225,228), TextMuted=Color3.fromRGB(140,95,108), Accent=Color3.fromRGB(240,55,80), AccentDark=Color3.fromRGB(190,35,55), Success=Color3.fromRGB(90,220,130), Error=Color3.fromRGB(255,100,100), Warning=Color3.fromRGB(255,190,60), Divider=Color3.fromRGB(35,20,25) },
    Rose = { name="Rose", BG=Color3.fromRGB(14,10,14), Sidebar=Color3.fromRGB(20,14,20), Card=Color3.fromRGB(28,20,28), CardHover=Color3.fromRGB(38,26,38), Border=Color3.fromRGB(46,32,46), Text=Color3.fromRGB(245,228,242), TextMuted=Color3.fromRGB(140,105,135), Accent=Color3.fromRGB(255,120,200), AccentDark=Color3.fromRGB(200,80,155), Success=Color3.fromRGB(90,220,140), Error=Color3.fromRGB(245,100,120), Warning=Color3.fromRGB(255,200,80), Divider=Color3.fromRGB(36,25,36) },
    Sunset = { name="Sunset", BG=Color3.fromRGB(15,10,8), Sidebar=Color3.fromRGB(22,14,10), Card=Color3.fromRGB(30,20,14), CardHover=Color3.fromRGB(42,27,18), Border=Color3.fromRGB(50,32,22), Text=Color3.fromRGB(248,235,225), TextMuted=Color3.fromRGB(150,115,90), Accent=Color3.fromRGB(255,140,60), AccentDark=Color3.fromRGB(210,100,30), Success=Color3.fromRGB(150,220,100), Error=Color3.fromRGB(240,100,90), Warning=Color3.fromRGB(255,210,80), Divider=Color3.fromRGB(38,24,16) },
    Mint = { name="Mint", BG=Color3.fromRGB(8,14,14), Sidebar=Color3.fromRGB(11,20,20), Card=Color3.fromRGB(15,27,27), CardHover=Color3.fromRGB(20,36,36), Border=Color3.fromRGB(24,42,42), Text=Color3.fromRGB(220,245,245), TextMuted=Color3.fromRGB(90,135,135), Accent=Color3.fromRGB(60,220,210), AccentDark=Color3.fromRGB(30,165,160), Success=Color3.fromRGB(120,240,180), Error=Color3.fromRGB(240,100,120), Warning=Color3.fromRGB(255,210,100), Divider=Color3.fromRGB(20,34,34) },
    Lavender = { name="Lavender", BG=Color3.fromRGB(12,10,16), Sidebar=Color3.fromRGB(18,15,23), Card=Color3.fromRGB(25,21,32), CardHover=Color3.fromRGB(34,28,43), Border=Color3.fromRGB(42,35,52), Text=Color3.fromRGB(238,232,248), TextMuted=Color3.fromRGB(125,110,150), Accent=Color3.fromRGB(200,170,255), AccentDark=Color3.fromRGB(155,125,210), Success=Color3.fromRGB(120,220,180), Error=Color3.fromRGB(240,110,140), Warning=Color3.fromRGB(255,215,130), Divider=Color3.fromRGB(32,27,42) },
    Ice = { name="Ice", BG=Color3.fromRGB(10,12,14), Sidebar=Color3.fromRGB(14,17,20), Card=Color3.fromRGB(20,24,28), CardHover=Color3.fromRGB(27,33,38), Border=Color3.fromRGB(35,42,48), Text=Color3.fromRGB(230,240,245), TextMuted=Color3.fromRGB(100,115,130), Accent=Color3.fromRGB(120,220,240), AccentDark=Color3.fromRGB(80,170,200), Success=Color3.fromRGB(130,230,180), Error=Color3.fromRGB(240,120,120), Warning=Color3.fromRGB(255,220,130), Divider=Color3.fromRGB(28,34,40) },
    Fire = { name="Fire", BG=Color3.fromRGB(15,8,6), Sidebar=Color3.fromRGB(22,11,8), Card=Color3.fromRGB(30,15,11), CardHover=Color3.fromRGB(42,20,14), Border=Color3.fromRGB(50,24,18), Text=Color3.fromRGB(250,230,220), TextMuted=Color3.fromRGB(150,100,85), Accent=Color3.fromRGB(255,90,40), AccentDark=Color3.fromRGB(200,60,20), Success=Color3.fromRGB(140,210,100), Error=Color3.fromRGB(255,100,90), Warning=Color3.fromRGB(255,200,60), Divider=Color3.fromRGB(40,20,14) },
    Monochrome = { name="Monochrome", BG=Color3.fromRGB(10,10,10), Sidebar=Color3.fromRGB(15,15,15), Card=Color3.fromRGB(22,22,22), CardHover=Color3.fromRGB(30,30,30), Border=Color3.fromRGB(38,38,38), Text=Color3.fromRGB(235,235,235), TextMuted=Color3.fromRGB(120,120,120), Accent=Color3.fromRGB(255,255,255), AccentDark=Color3.fromRGB(200,200,200), Success=Color3.fromRGB(180,220,180), Error=Color3.fromRGB(230,130,130), Warning=Color3.fromRGB(230,210,130), Divider=Color3.fromRGB(30,30,30) },
}
...
local function stroke(c, t, p)
    ...
    o.Color = c
    o.Thickness = t or 1
    pcall(function() o.ApplyStrokeMode = Enum.ApplyStrokeMode.Border end)
    o.Parent = p
    return o
end
...
local function applyTheme(name)
    ...
    for _, e in ipairs(Tracked.bg) do
        if e.obj and e.obj.Parent then pcall(function() e.obj.BackgroundColor3 = Theme[e.key] end) end
    end
    for _, e in ipairs(Tracked.text) do
        if e.obj and e.obj.Parent then pcall(function() e.obj.TextColor3 = Theme[e.key] end) end
    end
    for _, e in ipairs(Tracked.stroke) do
        if e.obj and e.obj.Parent then pcall(function() e.obj.Color = Theme[e.key] end) end
    end
end

local VI = {}
local function rf(p, s, pos, c, r, rot)
    local f = new("Frame", { Size = s, Position = pos, BackgroundColor3 = c, BorderSizePixel = 0, Rotation = rot or 0, Parent = p })
    corner(r or 2, f)
    return f
end
VI.Info = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(1,0,1,0), UDim2.new(0,0,0,0), c, 100)
    rf(h, UDim2.new(1,-4,1,-4), UDim2.new(0,2,0,2), Theme.Card, 100)
    rf(h, UDim2.new(0,2,0,2), UDim2.new(0.5,-1,0,3), c, 1)
    rf(h, UDim2.new(0,2,0,6), UDim2.new(0.5,-1,0,7), c, 1)
end
VI.Fly = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(0,14,0,3), UDim2.new(0,2,0,3), c, 3, -22)
    rf(h, UDim2.new(0,12,0,3), UDim2.new(0,2,0,8), c, 3, -12)
    rf(h, UDim2.new(0,9,0,3), UDim2.new(0,2,0,13), c, 3, 0)
    rf(h, UDim2.new(0,2,0,2), UDim2.new(0,16,0,2), c, 1)
end
VI.Palette = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(1,0,1,0), UDim2.new(0,0,0,0), c, 100)
    rf(h, UDim2.new(1,-3,1,-3), UDim2.new(0,1.5,0,1.5), Theme.Card, 100)
    rf(h, UDim2.new(0,4,0,4), UDim2.new(0,3,0,3), c, 4)
    rf(h, UDim2.new(0,4,0,4), UDim2.new(1,-7,0,3), c, 4)
    rf(h, UDim2.new(0,4,0,4), UDim2.new(0,3,1,-7), c, 4)
    rf(h, UDim2.new(0,4,0,4), UDim2.new(1,-7,1,-7), c, 4)
end
VI.Speed = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(0,16,0,2), UDim2.new(0,0,0,4), c, 1)
    rf(h, UDim2.new(0,11,0,2), UDim2.new(0,0,0,8), c, 1)
    rf(h, UDim2.new(0,16,0,2), UDim2.new(0,0,0,12), c, 1)
end
VI.Key = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    local hd = rf(h, UDim2.new(0,9,0,9), UDim2.new(0,0,0,3), c, 100)
    rf(hd, UDim2.new(0,3,0,3), UDim2.new(0.5,-1.5,0.5,-1.5), Theme.Card, 100)
    rf(h, UDim2.new(0,9,0,2), UDim2.new(0,8,0,7), c, 1)
    rf(h, UDim2.new(0,2,0,4), UDim2.new(0,12,0,7), c, 1)
end
VI.Close = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(0,12,0,2), UDim2.new(0,1,0,6), c, 1, 45)
    rf(h, UDim2.new(0,12,0,2), UDim2.new(0,1,0,6), c, 1, -45)
end
VI.Minimize = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(0,12,0,2), UDim2.new(0,1,0,7), c, 1)
end
VI.Check = function(p, c)
    local h = new("Frame", { Size = UDim2.new(1,0,1,0), BackgroundTransparency = 1, Parent = p })
    rf(h, UDim2.new(0,7,0,2), UDim2.new(0,1,0,7), c, 1, 45)
    rf(h, UDim2.new(0,12,0,2), UDim2.new(0,4,0,5), c, 1, -45)
end

local function mkIcon(parent, key, fb, color)
...
local function buildLogo(parent, size)
    ...
    local sk = size / 32
    rf(h, UDim2.new(0, 8*sk, 0, 13*sk), UDim2.new(0, 6*sk, 0, 3*sk), Theme.Accent, 1, 20)
    rf(h, UDim2.new(0, 8*sk, 0, 13*sk), UDim2.new(0, 6*sk, 0, 16*sk), Theme.Accent, 1, 20)
    rf(h, UDim2.new(0, 9*sk, 0, 26*sk), UDim2.new(0, 17*sk, 0, 3*sk), Theme.Accent, 1, 20)
    rf(h, UDim2.new(0, 11*sk, 0, 2*sk), UDim2.new(0, 7*sk, 0, 15*sk), Theme.Accent, 1, -25)
    return h
end
    ...
    local function FLY()
        ...
        spawn(function()
            repeat wait()
                ...
                elseif SPEED ~= 0 then
                    BV.Velocity = ((camera.CFrame.LookVector * (lCONTROL.F + lCONTROL.B)) + ((camera.CFrame * CFrame.new(lCONTROL.L + lCONTROL.R, 0, 0).p) - camera.CFrame.p)) * SPEED
                else
                    BV.Velocity = Vector3.new(0, 0, 0)
                end
...
local function tryClipboard()
    ...
    for _, fn in ipairs(funcs) do
        ...
        if ok and res and tostring(res) ~= "" and tostring(res) ~= "nil" then
            return tostring(res)
        end
    end
    return nil
...
local function fetchValidKeys()
    if not CONFIG.KeysURL then return {} end
    local ok, result = pcall(function() return game:HttpGet(CONFIG.KeysURL, true) end)
...
pcall(function()
    for _, o in pairs(CoreGui:GetChildren()) do
        if o.Name == "HallwayzUI" then o:Destroy() end
    end
    for _, o in pairs(PlayerGui:GetChildren()) do
        if o.Name == "HallwayzUI" then o:Destroy() end
    end
end)

print("[HALLWAYZ] Creating ScreenGui")
...
if gethui then
    ...
    if ok and ScreenGui.Parent then parentOK = true end
end
...
print("[HALLWAYZ] ScreenGui parent: " .. (ScreenGui.Parent and ScreenGui.Parent:GetFullName() or "NONE"))
...
local function showToast(title, desc, kind)
    ...
    tween(toast, 0.4, { Size = UDim2.new(1, 0, 0, 72), BackgroundTransparency = 0.05 }, Enum.EasingStyle.Back)
...
local function showConfirm(title, desc, onConfirm, onCancel)
    ...
    tween(card, 0.35, { Size = UDim2.new(0, 340, 0, 170), Position = UDim2.new(0.5, -170, 0.5, -85) }, Enum.EasingStyle.Back)
...
local function buildKeyUI(onSuccess)
    ...
    mkIcon(kch, "Close", "Close", Theme.TextMuted)
    ...
    mkIcon(ki, "Key", "Key", Theme.TextMuted)
    ...
    pasteBtn.MouseButton1Click:Connect(function()
        ...
        else showToast("Paste", "Clipboard not available", "error") end
    end)
    ...
    local function submit()
        ...
        if key == "" then
            ...
            showToast("Verify", "Key cannot be empty", "error")
            return
        end
        ...
        if valid or CONFIG.SkipKey then
            StatusLabel.Text = "Key valid"
            StatusLabel.TextColor3 = Theme.Success
            showToast("Success", "Welcome to Hallwayz", "success")
            wait(0.5)
...
local function buildMainUI()
    ...
    local entranceScale = new("UIScale", { Scale = 0.75, Parent = Main })
    tween(Main, 0.5, { BackgroundTransparency = 0 }, Enum.EasingStyle.Quart)
    tween(entranceScale, 0.55, { Scale = 1 }, Enum.EasingStyle.Back)
    delay(0.55, function() if entranceScale then entranceScale:Destroy() end end)
    ...
    local function winBtn(iconKey, fb, xOff)
        ...
        mkIcon(h, iconKey, fb, Theme.TextMuted)
    ...
    local function minimize()
        ...
        local glowStroke = new("UIStroke", { Color = Theme.Accent, Thickness = 2, Transparency = 0.6, Parent = floatingIcon })
        spawn(function()
            while floatingIcon and floatingIcon.Parent do
                tween(glowStroke, 2, { Transparency = 0.15 }); wait(2)
                tween(glowStroke, 2, { Transparency = 0.85 }); wait(2)
            end
        end)
    ...
    closeBtn.MouseButton1Click:Connect(function()
        showConfirm("Close Script", "Are you sure you want to close Hallwayz?", function()
            NOFLY()
            ScreenGui:Destroy()
        end)
    end)
    ...
    refreshPlayers()
    Players.PlayerAdded:Connect(function() wait(0.5); refreshPlayers() end)
    Players.PlayerRemoving:Connect(function() wait(0.5); refreshPlayers() end)
    ...
    mkIcon(fh, "Fly", "Fly", Theme.Accent)
    ...
    togBg.MouseButton1Click:Connect(function()
        flyOn = not flyOn
        updTog()
        if flyOn then NOFLY(); wait(0.05); sFLY(); showToast("Fly", "Fly enabled", "success")
    ...
    mkIcon(sh, "Speed", "Speed", Theme.Text)
    ...
    for i, tn in ipairs(ThemeOrder) do
        ...
        card.MouseButton1Click:Connect(function()
            applyTheme(tn)
            showToast("Theme Applied", tn, "success")
        end)
    end
    ...
    for i, p in ipairs(Pages_) do
        ...
        mkIcon(ih, p.icon, p.fb, Theme.TextMuted)
    ...
    selectPage("info")
    print("[HALLWAYZ] Main UI built")
end

print("[HALLWAYZ] Building Key UI")
local ok, err = pcall(function()
    buildKeyUI(function()
        print("[HALLWAYZ] Key passed, building Main UI")
        buildMainUI()
        wait(0.6)
        showToast("Welcome", "Hallwayz loaded — by Maverick", "success")
    end)
end)

if not ok then
    warn("[HALLWAYZ] Load error: " .. tostring(err))
end
